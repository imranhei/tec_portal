  ...
  return (
    <div className="space-y-6">
      <div className="w-full flex justify-center px-4 gap-4">
        <Button size="sm" onClick={() => navigate("/jobsheet")} >New Job Sheet</Button>
        <Button size="sm" onClick={() => navigate("/jobsheet/view")}>Previous Job Sheet</Button>
      </div>
    <div
    ...
    >
      ...
      <Dialog open={open} handler={handleOpen}>
        <DialogBody>
          Are you sure you want to add this <span className="font-bold">{field}</span> name to the suggestion list?
        </DialogBody>
        <DialogFooter>
          <Button
            variant="text"
          ...
          <Button variant="gradient" color="green" onClick={handleDropDownUpdate}>
            <span>Confirm</span>
          </Button>
        </DialogFooter>
      </Dialog>
